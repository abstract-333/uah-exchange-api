...
class RedisRepository:
    ...
    async def store_value(self, keys: Any, name_prefix: str = '') -> bool:
        ...
        status_of_storing = await redis_storage.set(name=self.name + name_prefix, value=json.dumps(keys), ex=60 * 60 * 24)
    ...
    async def get_stored_data(self, name_prefix: str = '') -> Any:
